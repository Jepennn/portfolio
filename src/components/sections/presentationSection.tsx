    ...
    <div className="flex flex-col items-center h-screen max-h-[710px] mb-20sm:mb-40">
      ...
      <div className="flex flex-col items-center mt-40 grow">
        ...
        <div className="flex flex-row w-full justify-start gap-3 sm:gap-5 mt-2">
          ...
          >
            <a target="_blank" rel="noopener noreferrer" href="https://github.com/Jepennn">
          ...
          >
            <a
              ...
              href="https://www.linkedin.com/in/jesper-hesselgren-412220197/"
            >
      ...
      >
        <span> Read more</span>
        <a href="#about" className="rounded-full animate-bounce">
          <ArrowDown size={32} className=""></ArrowDown>
        </a>
      </motion.div>
    </div>
  );
